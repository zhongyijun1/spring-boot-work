...
@Configuration
@EnableScheduling
@ComponentScan(basePackages = {"com.zhj.task.job"})
public class TaskConfig implements SchedulingConfigurer {
    ...
    public Executor taskExecutor() {
        return new ScheduledThreadPoolExecutor(20, new BasicThreadFactory.Builder().namingPattern("Jobzzz-Thread-%d").build());
    }
}
